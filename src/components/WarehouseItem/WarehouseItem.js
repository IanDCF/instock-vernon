            ...
            <section className="warehouse__info">
                <ul className="warehouse__list-items">
                    <li className="warehouse__item">
                        ...
                        <a className="warehouse__link">Manhattan { ">" }</a>
                    </li>
                    <li className="warehouse__item">
                        <span className="warehouse__item-label">ADDRESS</span>
                        <span className="warehouse__item-value">503 Broadway, New York, USA</span>
                    </li>
                ...
                <ul className="warehouse__list-items">
                    ...
                    <li className="warehouse__item">
                        ...
                        <span>+1 (629) 555-0129 <br />
                            paujla@instock.com</span>
                    </li>
                </ul>
            </section>
